...
'''
with open(r'C:\Users\student\Desktop\TeamGame\TeamGame\TeamGame\main.cpp', 'w', encoding='utf-8-sig') as f:
    f.write(content)

# Add /utf-8 to vcxproj
...
for cl in root.findall('.//ms:ClCompile', ns):
    ...
    if opts is None:
        opts = ET.SubElement(cl, 'AdditionalOptions')
        opts.text = '/utf-8 %(AdditionalOptions)'
    else:
        if opts.text and '/utf-8' not in opts.text:
            opts.text = '/utf-8 ' + opts.text
