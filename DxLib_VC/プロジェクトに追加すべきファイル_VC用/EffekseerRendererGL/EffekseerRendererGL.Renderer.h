...
CreateGraphicsDevice(OpenGLDeviceType deviceType,
                     bool isExtensionsEnabled = true);
...
CreateTexture(Effekseer::Backend::GraphicsDeviceRef graphicsDevice,
              GLuint buffer, bool hasMipmap,
              const std::function<void()> &onDisposed);
...
public:
  ...
  */
  ...
  Create(Effekseer::Backend::GraphicsDeviceRef graphicsDevice,
         int32_t squareMaxCount, bool isPremultipliedAlphaEnabled = false);
