...
/**
        ...
        @param	openFunc
   内部処理用(文字コード処理用)のための引数。必ずデフォルト引数を使用する。
        @param	readSizeFunc
   内部処理用(文字コード処理用)のための引数。必ずデフォルト引数を使用する。
        @return	成功した場合は0、失敗した場合は-1を返す。
*/
int Effekseer_Init(
    int particleMax, EffekseerFileOpenFunc openFunc = __Effekseer_FileRead_open,
...
@param	scale
ウインドウサイズに対する歪みに使用するバッファの拡大率(1.0がデフォルト)
@return	成功した場合は0、失敗した場合は-1を返す。
*/
...
*/
int SetPosPlayingEffekseer2DEffect(int playingEffectHandle, float x, float y,
                                   float z);
...
/**
        ...
        ※エフェクトが既に再生終了していても成功を返す。
*/
int SetPosPlayingEffekseer3DEffect(int playingEffectHandle, float x, float y,
                                   float z);
...
※エフェクトが既に再生終了していても成功を返す。
*/
int SetRotationPlayingEffekseer2DEffect(int playingEffectHandle, float x,
                                        float y, float z);
...
※エフェクトが既に再生終了していても成功を返す。
*/
int SetRotationPlayingEffekseer3DEffect(int playingEffectHandle, float x,
                                        float y, float z);
...
/**
        ...
        ※エフェクトが既に再生終了していても成功を返す。
*/
int SetScalePlayingEffekseer2DEffect(int playingEffectHandle, float x, float y,
                                     float z);
...
/**
        ...
        ※エフェクトが既に再生終了していても成功を返す。
*/
int SetScalePlayingEffekseer3DEffect(int playingEffectHandle, float x, float y,
                                     float z);
...
※エフェクトが既に再生終了していても成功を返す。
*/
int SetColorPlayingEffekseer2DEffect(int playingEffectHandle, int r, int g,
                                     int b, int a);
...
/**
        ...
        ※エフェクトが既に再生終了していても成功を返す。
*/
int SetColorPlayingEffekseer3DEffect(int playingEffectHandle, int r, int g,
                                     int b, int a);
...
*/
void SetDynamicInput2DEffect(int playingEffectHandle, int32_t index,
                             float value);
...
/**
   ...
   再生中にエフェクトのパラメーターを変更する動的パラメーターを設定する。
*/
void SetDynamicInput3DEffect(int playingEffectHandle, int32_t index,
                             float value);
