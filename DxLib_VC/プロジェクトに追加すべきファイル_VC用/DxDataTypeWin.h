...
// C:\Program Files (x86)\Windows Kits\8.1\Include\um\combaseapi.h(229,21):
...
#pragma comment(lib,                                                           \
                "DxUseCLibW_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_x64_d.lib")     //  ＤＸライブラリ使用指定
#pragma comment(lib, "DxUseCLib_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#endif
#else                                      // _DEBUG
...
#pragma comment(lib, "DxUseCLibW_x64.lib") //  標準Ｃライブラリを使用する部分の
                                           //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_x64.lib")     //  ＤＸライブラリ使用指定
#pragma comment(lib, "DxUseCLib_x64.lib") //  標準Ｃライブラリを使用する部分の
                                          //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#else  // _WIN64
...
#pragma comment(lib, "DxUseCLibW_d.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_d.lib")     //  ＤＸライブラリ使用指定
#pragma comment(lib, "DxUseCLib_d.lib") //  標準Ｃライブラリを使用する部分の lib
                                        //  ファイルの使用指定
#endif
#else                                  // _DEBUG
...
#pragma comment(lib, "DxUseCLibW.lib") //  標準Ｃライブラリを使用する部分の lib
                                       //  ファイルの使用指定
#else
#pragma comment(lib, "DxLib.lib")     //  ＤＸライブラリ使用指定
#pragma comment(lib, "DxUseCLib.lib") //  標準Ｃライブラリを使用する部分の lib
                                      //  ファイルの使用指定
#endif
#endif // _DEBUG
#endif // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2015_x64_ItrDbgLv0_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                               //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x64_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                          //  lib ファイルの使用指定
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2015_x64_ItrDbgLv0_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                              //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x64_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                                // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x64_MD.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2015_x64_MD.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x64_MD.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#else  // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2015_x86_ItrDbgLv0_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                               //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x86_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                          //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2015_x86_ItrDbgLv0_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                              //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x86_MDd.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                                // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x86_MD.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2015_x86_MD.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x86_MD.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#endif // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2015_x64_ItrDbgLv0_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                               //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x64_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                          //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2015_x64_ItrDbgLv0_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                              //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x64_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                                // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x64_MT.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2015_x64_MT.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x64_MT.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#else  // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2015_x86_ItrDbgLv0_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                               //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x86_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                          //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2015_x86_ItrDbgLv0_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                              //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x86_MTd.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                                // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2015_x86_MT.lib") //  標準Ｃライブラリを使用する部分の
                                         //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2015_x86_MT.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2015_x86_MT.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#endif // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2013_x64_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                             //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2013_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2013_x64_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2013_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                       //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                             // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2013_x64.lib") //  標準Ｃライブラリを使用する部分の
                                      //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2012_x64.lib") //  ＤＸライブラリ使用指定
#pragma comment(lib,                                                           \
                "DxUseCLib_vs2013_x64.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#else  // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2013_x86_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                             //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2013_x86_d.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2013_x86_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2013_x86_d.lib") //  標準Ｃライブラリを使用する部分の
                                       //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                             // _DEBUG
...
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2013_x86.lib") //  標準Ｃライブラリを使用する部分の
                                      //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2012_x86.lib") //  ＤＸライブラリ使用指定
#pragma comment(lib,                                                           \
                "DxUseCLib_vs2013_x86.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#endif // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2012_x64_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                             //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2012_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
#pragma comment(lib, "DxLib_vs2012_x64_d.lib") //  ＤＸライブラリ使用指定
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2012_x64_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2012_x64_d.lib") //  標準Ｃライブラリを使用する部分の
                                       //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                             // _DEBUG
...
#pragma comment(lib, "DxLibW_vs2012_x64.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2012_x64.lib") //  標準Ｃライブラリを使用する部分の
                                      //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2012_x64.lib") //  ＤＸライブラリ使用指定
#pragma comment(lib,                                                           \
                "DxUseCLib_vs2012_x64.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#endif
#endif // _DEBUG
#else  // _WIN64
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLibW_vs2012_x86_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                             //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2012_x86_d.lib") //  標準Ｃライブラリを使用する部分の
                                        //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#else
#pragma comment(lib, "DxLib_vs2012_x86_d.lib") //  ＤＸライブラリ使用指定
...
#pragma comment(                                                               \
    lib,                                                                       \
    "DxUseCLib_vs2012_x86_ItrDbgLv0_d.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#else
#pragma comment(                                                               \
    lib, "DxUseCLib_vs2012_x86_d.lib") //  標準Ｃライブラリを使用する部分の
                                       //  lib ファイルの使用指定
#endif // defined(_ITERATOR_DEBUG_LEVEL) && _ITERATOR_DEBUG_LEVEL == 0
#endif
#else                                             // _DEBUG
...
#pragma comment(lib, "DxLibW_vs2012_x86.lib") //  ＤＸライブラリ使用指定
#pragma comment(                                                               \
    lib, "DxUseCLibW_vs2012_x86.lib") //  標準Ｃライブラリを使用する部分の
                                      //  lib ファイルの使用指定
#else
#pragma comment(lib, "DxLib_vs2012_x86.lib") //  ＤＸライブラリ使用指定
#pragma comment(lib,                                                           \
                "DxUseCLib_vs2012_x86.lib") //  標準Ｃライブラリを使用する部分の
                                            //  lib ファイルの使用指定
#endif
#endif                                 // _DEBUG
#endif                                 // _WIN64
...
#ifdef _DEBUG
#pragma comment(                                                               \
    lib, "libbulletcollision_vc8_d.lib") // Visual C++ 8.0 でコンパイルした
                                         // Bullet Physics ライブラリ
#pragma comment(lib, "libbulletdynamics_vc8_d.lib")
#pragma comment(lib, "libbulletmath_vc8_d.lib")
#else
#pragma comment(lib,                                                           \
                "libbulletcollision_vc8.lib") // Visual C++ 8.0 でコンパイルした
                                              // Bullet Physics ライブラリ
...
#ifdef _DEBUG
#pragma comment(                                                               \
    lib, "libbulletcollision_vc6_d.lib") // Visual C++ 6.0 でコンパイルした
                                         // Bullet Physics ライブラリ
#pragma comment(lib, "libbulletdynamics_vc6_d.lib")
#pragma comment(lib, "libbulletmath_vc6_d.lib")
#else
#pragma comment(lib,                                                           \
                "libbulletcollision_vc6.lib") // Visual C++ 6.0 でコンパイルした
                                              // Bullet Physics ライブラリ
...
#define DX_READSOUNDFUNCTION_ACM                                               \
  (1 << (DX_READSOUNDFUNCTION_DEFAULT_NUM + 0)) // ACM を使用した読み込み処理
#define DX_READSOUNDFUNCTION_MP3                                               \
  (1 << (DX_READSOUNDFUNCTION_DEFAULT_NUM +                                    \
         1)) // ACM を使用した MP3 の読み込み処理
#define DX_READSOUNDFUNCTION_DSMP3                                             \
  (1 << (DX_READSOUNDFUNCTION_DEFAULT_NUM +                                    \
         2)) // DirectShow を使用した MP3 の読み込み処理
#define DX_READSOUNDFUNCTION_MF                                                \
  (1 << (DX_READSOUNDFUNCTION_DEFAULT_NUM +                                    \
         3)) // Media Foundation を使用した読み込み処理
...
// エラーコード
#define DX_ERRORCODE_WIN_DESKTOP_24BIT_COLOR                                   \
  (0x01010001) // デスクトップが２４ビットカラーモードだった
#define DX_ERRORCODE_WIN_DOUBLE_START (0x01010002) // 二重起動
#define DX_ERRORCODE_WIN_FAILED_CREATEWINDOW                                   \
  (0x01010003) // ウインドウの作成に失敗
#define DX_ERRORCODE_WIN_FAILED_ASYNCLOAD_CREATE_THREAD                        \
  (0x01010004) // 非同期読み込み処理を行うスレッドの立ち上げに失敗

#define DX_ERRORCODE_WIN_FAILED_CREATE_DIRECTDRAW7                             \
  (0x01020001) // DirectDraw7 の取得に失敗
#define DX_ERRORCODE_WIN_FAILED_INITIALIZE_DIRECTDRAW7                         \
  (0x01020002) // DirectDraw7 の初期化に失敗
#define DX_ERRORCODE_WIN_NOT_COMPATIBLE_SCREEN_COLOR_MODE                      \
  (0x01020003) // 非対応の画面カラーモードが指定された
#define DX_ERRORCODE_WIN_FAILED_CHANGE_DISPLAY_SETTINGS                        \
  (0x01020004) // Win32API の ChangeDisplaySettings
               // を使用した画面モードの変更に失敗
