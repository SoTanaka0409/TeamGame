...
public:
  ...
  */
  ...
  /**
          ...
          @note
          \if English
          In a right-handed coordinate system, when the right thumb is in1 and
     the index finger is in2, it returns the direction of the middle finger.<BR>
          In a left-handed coordinate system, when the left thumb is in1 and the
     index finger is in2, it returns the direction of the middle finger.<BR>
          \endif
          \if Japanese
  ...
  */
  std::array<float, 3> ToFloat3() const { return {X, Y, Z}; }
  ...
  */
  std::array<float, 4> ToFloat4() const { return {X, Y, Z, 1.0f}; }
};
