...
using ResourceBinder =
    std::variant<std::nullptr_t, TextureBinder, ComputeBufferBinder>;
...
public:
  ...
  void SetTexture(int32_t slot, TextureRef texture, TextureWrapType wrapType,
...
public:
  ...
  */
  ...
  /**
          ...
          @return	Succeeded in updating?
  */
  virtual bool UpdateComputeBuffer(ComputeBufferRef &buffer, int32_t size,
                                   int32_t offset, const void *data) {
    return false;
  }
  ...
  */
  ...
  virtual ShaderRef CreateComputeShader(const void *csData,
                                        int32_t csDataSize) {
    return ShaderRef{};
  }
  ...
  */
  virtual ComputeBufferRef CreateComputeBuffer(int32_t elementCount,
                                               int32_t elementSize,
                                               const void *initialData,
                                               bool readOnly) {
    return nullptr;
