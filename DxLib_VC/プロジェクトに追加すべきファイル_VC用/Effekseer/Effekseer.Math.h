...
*/
template <class To, class From> inline To BitCast(From from) {
...
inline float NormalizeAngle(float angle) {
  ...
  return angle -
         ((int)(angle * 0.159154943f + BitCast<float>(ofs)) * 6.283185307f);
}
...
inline void SinCos(float x, float &s, float &c) {
  ...
  s = x * (1.0f - x2 / 6.0f + x4 / 120.0f - x6 / 5040.0f + x8 / 362880.0f -
           x10 / 39916800.0f);
  c = 1.0f - x2 / 2.0f + x4 / 24.0f - x6 / 720.0f + x8 / 40320.0f -
      x10 / 3628800.0f;
}
