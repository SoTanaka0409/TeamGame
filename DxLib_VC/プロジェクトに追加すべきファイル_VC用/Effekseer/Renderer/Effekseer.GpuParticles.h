...
template <class T> inline vector2<T> operator*(vector2<T> a, T b) {
  return vector2<T>{a.x * b, a.y * b};
}

template <class T> inline vector3<T> operator+(vector3<T> a, vector3<T> b) {
  return vector3<T>{a.x + b.x, a.y + b.y, a.z + b.z};
}

template <class T> inline vector3<T> operator*(vector3<T> a, T b) {
  return vector3<T>{a.x * b, a.y * b, a.z * b};
}

template <class T> inline vector4<T> operator+(vector4<T> a, vector4<T> b) {
  return vector4<T>{a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w};
}

template <class T> inline vector4<T> operator*(vector4<T> a, T b) {
...
public:
  virtual GpuParticles::ResourceRef
  CreateResource(const GpuParticles::ParamSet &paramSet, const Effect *effect) {
    return nullptr;
  }
};
...
public:
  ...
  virtual EmitterID NewEmitter(GpuParticles::ResourceRef paramRes,
  ...
  virtual void SetTransform(EmitterID emitterID,
                            const Effekseer::Matrix43 &transform) {}
