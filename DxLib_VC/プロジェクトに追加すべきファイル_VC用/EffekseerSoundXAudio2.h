...
public:
  ...
  const XAUDIO2_BUFFER *GetBuffer() const { return &buffer_; }
...
public:
  ...
  */
  static SoundRef Create(IXAudio2 *xaudio2, int32_t num1chVoices,
  ...
  */
  ...
  CreateSoundLoader(::Effekseer::FileInterfaceRef fileInterface = NULL) = 0;
