...
public:
  ...
  */
  ...
  /**
          @brief
          added a command into supecified context. This function is supported in
     some platform. Internal context is not used if platformContextPtr is null
     in Metal. This function can be called once by a frame.
  */
  ...
  virtual void SetVertexBuffer(Buffer *vertexBuffer, int32_t stride,
                               int32_t offset);
  virtual void SetIndexBuffer(Buffer *indexBuffer, int32_t stride,
                              int32_t offset = 0);
  ...
  virtual void SetComputeBuffer(Buffer *computeBuffer, int32_t stride,
  ...
  */
  ...
  /**
          @brief	copy a texture
  */
  virtual void CopyTexture(Texture *src, Texture *dst, const Vec3I &srcPos,
                           const Vec3I &dstPos, const Vec3I &size, int srcLayer,
                           int dstLayer) {}

  /**
          @brief specify textures
  */
  virtual void SetTexture(Texture *texture, TextureWrapMode wrapMode,
  ...
  */
  ...
  /**
          @brief
          added a command into supecified renderpass. This function is supported
     in some platform.
  */
  ...
  */
  ...
  virtual bool RecordTimestamp(Query *query, uint32_t queryIndex) {
    return false;
  }
  ...
  virtual bool BeginComputePassWithPlatformPtr(void *platformPtr) {
    return false;
  }
  virtual bool EndComputePassWithPlatformPtr() { return false; }

  virtual void Dispatch(int32_t groupX, int32_t groupY, int32_t groupZ,
  ...
  */
  virtual void SetImageData2D(Texture *texture, int32_t x, int32_t y,
