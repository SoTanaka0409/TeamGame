...
public:
  ...
  /*
   ...
   @note
   the argument is ignored on Mac. This function notify that an window size is
  changed.
  **/
  ...
  /**
          ...
          Don't use it for the many purposes, please input Clear or
     SetRenderPass immediately.
  */
  virtual RenderPass *GetCurrentScreen(const Color8 &clearColor = Color8(),
