...
private:
  ...
  ::Effekseer::SIMD::Vec3f lightDirection_ =
  ...
  void SetCameraParameterInternal(const ::Effekseer::SIMD::Vec3f &front,
                                  const ::Effekseer::SIMD::Vec3f &position);
...
public:
  ...
  void SetCameraParameter(const ::Effekseer::Vector3D &front,
  ...
  GetProxyTexture(EffekseerRenderer::ProxyTextureType type);
  ...
  void GetDepth(::Effekseer::Backend::TextureRef &texture,
                DepthReconstructionParameter &reconstructionParam);

  void SetDepth(::Effekseer::Backend::TextureRef texture,
